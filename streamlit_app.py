...
# listings with a price above 300 zloty per night
dataframe = dataframe[dataframe["Price"] <= 300]

# Display as integer
dataframe["Airbnb Listing ID"] = dataframe["Airbnb Listing ID"].astype(int)
# Round of values
dataframe["Price"] = dataframe["Price"].round(2).astype(str) + " zł" # <--- CHANGE THIS POUND SYMBOL IF YOU CHOSE CURRENCY OTHER THAN POUND
